...
(function (ReflectionFlag) {
    ...
    ReflectionFlag[ReflectionFlag["CoveoComponentOptions"] = 16384] = "CoveoComponentOptions";
...
class ReflectionFlags extends Array {
    ...
    get isCoveoComponentOptions() {
        return this.hasFlag(ReflectionFlag.CoveoComponentOptions);
    }
    setFlag(flag, set) {
        switch (flag) {
